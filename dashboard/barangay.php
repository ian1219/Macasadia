	...
	<body>
		...
		<div class="wrapper">
			...
			<main class="page-content">
				<h6 class="mb-0 text-uppercase">Barangay List
        </h6>
				<hr/>
				<div class="d-grid gap-2 mb-3">
					<button type="button" class="btn btn-primary btn-blocked" data-bs-toggle="modal" data-bs-target="#addnewbarangay"> Add New </button>
				</div>
		
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							<table id="barangay" class="table table-striped table-bordered" style="width:100%">
								<thead>
									<tr>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-body">
							...
							<div><p><b>Barangay Name:</b> <span id="user_id"></span></p></div>

							<div>Are you sure you want to delete?</p></div>
						</div>
						<div class="modal-footer  border-0">
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
							<button type="button" class="btn btn-primary" onclick="deleteBarangay()">Proceed</button>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-body">
							...
							<div><p><b>Barangay Name:</b> <span id="edit_user_id"></span></p></div>


							<form>
								
								<div class="d-flex flex-column">
									<label class="p-0" for="mname">Barangay Name</label>
									<input class="p-1" type="text" id="brgy_name_update" name="brgy_name_update" placeholder="Barangay Name"> </div>
						...
						<div class="modal-footer  border-0">
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
							<button type="button" class="btn btn-primary" onclick="editBarangay()">Update</button>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- Modal -->
			<div class="modal fade" id="addnewbarangay" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addnewbarangayLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content modal-content-bg">
						<div class="modal-body">
							...
							<div class="text-center mt-2">
								<h4 class="title">Fill Up Information</h4> </div>
							<form>
								<div class="d-flex flex-column">
									<label class="p-0" for="fname">Barangay Number</label>
									<input class="p-1" type="text" id="brgy_number" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');"  name="brgy_number" placeholder="Input Number"> </div>
								<div class="d-flex flex-column">
									<label class="p-0" for="mname">Barangay Name</label>
									<input class="p-1" type="text" id="brgy_name" name="brgy_name" placeholder="Barangay Name"> </div>
								
							</form>
						</div>
						<div class="modal-footer  border-0">
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
							<button type="button" class="btn btn-primary" onclick="add_new_barangay();">Submit</button>
						</div>
					</div>
				</div>
			</div>
		...
		<script src="../assets/fetch/barangay.js"></script>
	</body>
</html>